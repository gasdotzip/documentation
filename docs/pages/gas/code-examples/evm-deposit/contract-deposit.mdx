...
> The Contract Deposit method is maintained for existing integrations, but new implementations should use the [Direct Deposit method](/gas/code-examples/evm-deposit/direct-deposit).
...
For a comprehensive list of all supported chains and their respective contract addresses for v1 contract deposits, please refer to the [Contract Deposit Supported Chains](/gas/chain-support/deposit#contract-deposit) section.
