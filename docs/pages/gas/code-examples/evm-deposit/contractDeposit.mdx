...
:::note
For new integrations, we recommend using the [EOA Deposit method](/gas/code-examples/evm-deposit/eoaDeposit) due to its simplicity and efficiency. However, if you require low-level call functionality, you may continue to use this Contract Deposit method.
:::
