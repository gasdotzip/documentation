...
<Callout type="warning">
  ...
  deposit with a low-level call, please use the [Contract Deposit](/gas/code-examples/contractDeposit)
</Callout>
...
- 03: Send to the next 32 bytes as a Solana address
...
- Solana addresses: base58 string that decodes to 32 bytes and validates on curve
